...
- **2017 Fire Ants Launch** (11-13APR) - car, hotels
    ...
    * Format
        - Day 1 - Crawler (Aaron, Benita), Mobile UI (Darren, Bat).
        - Day 2 - Mobile UI (Darren, Aaron), Data Analytics (Benita, Dan, Bat), **Dinner**
        - Day 3 - API (Aaron, Darren), Data Analytics (Benita, Dan, Bat), **Drillers?**
